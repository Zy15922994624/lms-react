...
export const ROUTES = {
  ...
  COURSE_MEMBERS: (id: string | number) => `/courses/${id}/members`,
  COURSE_RESOURCES: (id: string | number) => `/courses/${id}/resources`,
  COURSE_DISCUSSIONS: (id: string | number) => `/courses/${id}/discussions`,

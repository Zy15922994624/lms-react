    ...
    <CourseWorkspaceFrame course={course}>
      <section className="app-panel px-6 py-6 sm:px-8">
        <div className="max-w-2xl">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-stone-400">课程资源</div>
          <h2 className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-stone-900">资源工作区</h2>
          <p className="mt-4 text-sm leading-7 text-stone-500">
            资源模块后续会在这里接入。当前先保留课程上下文和入口位置。
          </p>
